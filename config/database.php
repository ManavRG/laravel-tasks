    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('AZURE_MYSQL_DBNAME', 'msdocs-laravel-mysql-925-database'),
            'username' => env('AZURE_MYSQL_USERNAME', 'yvettjqbms'),
            'password' => env('AZURE_MYSQL_PASSWORD', '87fVqA7pQx$VIOI5'),
